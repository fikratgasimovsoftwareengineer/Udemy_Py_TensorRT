...
'''
    ...
    target: YOLOV7 DNN Inference on Images
'''
...
class YoloV7DNN_Detection:
    ...
    def inference_run (self, image):
        ...
        for (class_id, score, box) in zip(getClasses, getScores, getBoxes):
            ...
            cv2.putText(image,label, (box[0]-30, box[1]-10), cv2.FONT_HERSHEY_SIMPLEX, 0.5,  (0, 0, 255), 2)
...
def main():
    ...
    image_path = '/tensorfl_vision/YOLOV5_CPP/data/Images'
